### API & Routing
- [ ] Create a `GET /device-info.json` endpoint that returns current configurations as JSON.
...
- [x] Add a call to request current configurations from `/device-info.json`.
